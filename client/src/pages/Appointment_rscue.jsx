...
import { Accordion, AccordionHeader, AccordionBody, Card, Collapse, Button, Input, Option, Select, Textarea, Typography } from "@material-tailwind/react"
...
const Appointment = () => {
    ...
    */
    ...
    return(
        ...
        <Card className='flex bg-gray-300'>
            <div className='mx-40 my-6 rounded-lg'>
